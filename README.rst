Getting Started
---------------
You can directly clone the repository through ``git clone https://github.com/timmykuo/mitopipeline.git` and running ``python3 setup.py install`` after navigating to the cloned directory. `Documentation <https://mitopipeline.readthedocs.io/en/latest/>`_ is hosted through readthedocs.
